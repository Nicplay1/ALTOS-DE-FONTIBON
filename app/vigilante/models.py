...
class Paquete(models.Model):
    ...
    cod_usuario_recepcion = models.ForeignKey(Usuario, related_name='paquetes_recepcion', on_delete=models.CASCADE)
    fecha_entrega = models.DateTimeField(null=True, blank=True)
    cod_usuario_entrega = models.ForeignKey(Usuario, related_name='paquetes_entrega', on_delete=models.CASCADE, null=True, blank=True)
